...
function ProjectComponent() {
  ...
  if (!project) return <div>Loading...</div>
    ...
    return <div className="p-5 w-full flex flex-col gap-2">
      ...
      <div className="flex items-center justify-between gap-5">
        <div className='w-1/2'>
          ...
          <Input className="my-2" type="text" value={"Customer Name"} />
        </div>
        <div className='w-1/2'>
          <Label>Project Manager</Label>
          <Input className="my-2" type="text" value={"Project Manager"} />
        </div>
      </div>
